...
type Audit struct {
	...
	//        uint32 peer_id = 2;      // s_j: primary id
	//        oneof msgcontent {
	//            uint32 nullmessage = 3;
	//            Prepare prepmsg = 4;
	//            Commit commsg = 5;
	//        }
	//        bytes authonticator = 6; // UI_i: primary UI
	//    }
...
func (m *Audit) GetSequence() uint64 {
	if m != nil {
		return m.Sequence
	}
	return 0
...
func (m *Audit) GetAuthenticator() []byte {
	if m != nil {
...
var fileDescriptor_4dc296cbfe5ffcd5 = []byte{
	...
	,
}
